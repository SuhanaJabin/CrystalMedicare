        ...
        <div className="mt-5">
          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            {featuresList.map((feature) => (
              <div key={feature.name} className="relative group hover:bg-opacity-20 hover:bg-gray-400 rounded-2xl p-7">
                <dt>
                  <div
                  ...
                  >
                    <h1 className='font-bold text-xl transition-all duration-500 group-hover:text-2xl'>{feature.number}</h1>
