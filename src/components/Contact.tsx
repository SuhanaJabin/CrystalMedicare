...
const Contact = () => {
  return (
    <div id="about" className="mx-auto container xl:px-20 lg:px-12 py-12">
      <div className="flex items-center justify-center">
        <div className="flex w-full lg:w-5/6 flex-wrap items-center mb-10 justify-center">
          <div>
            <h1 className="lg:text-5xl text-3xl text-gray-900 text-center font-bold mb-10">
              CONTACT 
            </h1>
            <p className="transition-all duration-500 hover:text-primary font-semibold text-xl lg:text-2xl text-gray-500 p-3 text-justify">
              We&apos;re here to assist you with all your healthcare needs. Reach out to us through any of the follow
            </p>

            <div className="flex flex-row mt-5">
              <p className="text-xl font-semibold lg:text-2xl text-gray-500 text-justify">
                Address:
              </p>
              <div className="flex flex-col ml-5 text-xl font-semibold lg:text-2xl text-gray-500 text-justify">
                <p>Apartment 38</p>
            ...
            <h1 className="mt-2 text-xl lg:text-2xl text-gray-500 font-semibold text-justify">
            ...
            <p className="transition-all duration-500 hover:text-primary mt-5 text-xl lg:text-2xl text-gray-500 font-semibold p-3 text-justify">
