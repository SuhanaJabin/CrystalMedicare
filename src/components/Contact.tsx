      ...
      <div className="flex items-center justify-center">
        <div className="flex w-full p-1 lg:w-5/6 flex-wrap items-center mb-10 justify-center">
          <div>
            ...
            <p className="transition-all duration-500 hover:text-primary text-xl lg:text-2xl text-tertiary p-3 text-justify">
            ...
            <div className="flex flex-row mt-5">
              ...
              <div className="flex flex-col pl-1 ml-5 text-xl lg:text-2xl text-tertiary text-justify">
                <p>Apartment 38</p>
            ...
            <h1 className="mt-2 pl-1 text-xl lg:text-2xl text-tertiary text-justify">
            ...
            <p className="transition-all duration-500 pl-1 hover:text-primary mt-5 text-xl lg:text-2xl text-tertiary p-3 text-justify">
