        ...
        <div className="flex w-full p-1 lg:w-5/6 flex-wrap items-center mb-10 justify-center">
          <div>
            ...
            <div className="flex flex-row mt-5">
              <p className="pl-1 text-xl font-semibold lg:text-2xl text-gray-500 text-justify">
                Address:
              </p>
              <div className="flex flex-col pl-1 font-semibold ml-5 text-xl lg:text-2xl text-gray-500 text-justify">
                <p>Apartment 38</p>
            ...
            <h1 className="mt-2 pl-1 text-xl lg:text-2xl text-gray-500 font-semibold text-justify">
            ...
            <p className="transition-all duration-500 pl-1 font-semibold hover:text-primary mt-5 text-xl lg:text-2xl text-gray-500 p-3 text-justify">
