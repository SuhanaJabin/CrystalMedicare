      ...
      <div className="flex items-center justify-center">
        <div className="flex w-full p-1 lg:w-5/6 flex-wrap items-center mb-10 justify-center">
          <div>
            ...
            <p className="transition-all duration-500 hover:text-primary sm:text-xl lg:text-2xl  text-gray-600 ">
            ...
            <p className="transition-all duration-500 hover:text-primary mt-5  sm:text-xl  lg:text-2xl  text-gray-600">
