...
const MainHero = () => {
  ...
  return (
    <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
      <div className="sm:justify-center lg:mt-20 lg:text-left sm:text-center group ">
        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:ml-28 mb-16 ">
          <div className="rounded-md shadow">
            <a
              ...
              className={`w-auto flex items-center  lg:mt-10 sm:mt-10 justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-background bg-primary hover:bg-border hover:text-primary md:py-4 md:text-lg md:px-10`}
            >
