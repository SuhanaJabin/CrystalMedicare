  ...
  return (
    <div className={`py-12 bg-background`} id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section
          role="complementary"
          className="simple white-back quotes no-fouc"
        >
          <blockquote>
            <p>
              <strong>to cite (verb)</strong>: to acknowledge (give credit to)
              the original author or artist by providing a reference.
            </p>
            <cite>
              Someone Said
              <br />
              <a href="#">Said it Here</a>
            </cite>
          </blockquote>
          <blockquote>
            <p>
              <strong>citation (noun)</strong>: a properly formatted line of
              text that indicates the source for a quote, idea, fact etc. that
              you use.
            </p>
            <cite>
              Someone Said
          ...
          <blockquote>
            <p>
              If you are repeating a section of the article for emphasis, use an
              aside element.
            </p>
            <cite>
              Someone Said
          ...
          <blockquote>
            <p>
              A blockquote element cannot be inside a paragraph, and since HTML4
              actually needs to contain paragraphs.
            </p>
            <cite>
              Someone Said
              <br />
        ...
        <section className="quotes">
          ...
          <div className="bubble">
            <blockquote>
              ...
              brought about by a serenity of soul. Peace is not merely the
          ...
          <div className="bubble">
            <blockquote>
              ...
              than the wound we suffered, to forgive the one that inflicted it.
          ...
          <div className="bubble">
            <blockquote>
              ...
              to realise - than that of peace in the world. May we never lose
              our faith in it or our resolve to do everything that can be done
