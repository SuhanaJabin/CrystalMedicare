      ...
      <div className="container max-w-5xl mx-auto m-8 p-3">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="w-11/12 sm:w-1/2 p-6 mb-14 mt-7 group transition-all duration-300 text-center">
            ...
            <p className="text-tertiary text-xl lg:text-2xl font-bold group-hover:text-gray-800 group-hover:font-bold transition-all duration-500 mt-12 text-justify">
